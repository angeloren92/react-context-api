      ...
      <div className="container">
        <section className="row row-cols-1 row-cols-md-2 py-5 g-5">
          ...
          <div className="col">
            <div className="card bg-light h-100 shadow">
              <figure className="card-body text-center d-flex flex-column justify-content-between align-items-center">
                <Link to="/chi_siamo"><img src={imgChiSiamo} alt="Img Products" className='img-fluid rounded-3' /></Link>
                ...
                <Link to="/chi_siamo" className='btn w-75 btn-warning rounded-5'>LA NOSTRA STORIA</Link>
              </figure>
            </div>
          </div>
        </section>
